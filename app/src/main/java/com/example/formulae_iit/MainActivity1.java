...
public class MainActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ColorDrawable colorDrawable
                = new ColorDrawable(Color.parseColor("#24B867"));
        actionBar.setBackgroundDrawable(colorDrawable);
       // changeTitleBarColor("#E1F5FE");
        list = findViewById(R.id.chemistrytopic);
    ...
    private void openImageActivity(String  imageResId) {
        Intent intent = new Intent(MainActivity1.this, phy1.class);
